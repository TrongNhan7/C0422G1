package test.phone.src.de_1.service.control;

import test.phone.src.de_1.models.RealPhone;
import test.phone.src.de_1.service.IService.IService;
import test.phone.src.de_1.util.NotFoundProductException;
import test.phone.src.de_1.util.ReadAndWrite;
import test.phone.src.de_1.util.Regex;
...
public class RealPhoneServiceImpl implements IService {
    ...
    private static final String PATH_FILE_REALMOBILES = "src/test/phone/src/de_1/data/realMobile";
